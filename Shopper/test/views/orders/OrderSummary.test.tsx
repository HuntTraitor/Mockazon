...
it('Loads order summary', async () => {
  ...
  screen.getByText(Number(mockOrder.subtotal).toFixed(2), { exact: false });
  screen.getByText(Number(mockOrder.tax).toFixed(2), { exact: false });
