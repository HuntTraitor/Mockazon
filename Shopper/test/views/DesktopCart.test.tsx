...
it('Renders successfully', async () => {
  ...
  // change select with aria label 'Quantity Selector':
  const select = screen.getByLabelText('Quantity Selector for abc');
  fireEvent.change(select, { target: { value: '2' } });

  // Click on delete button:
  const deleteButton = screen.getByLabelText('cart:Delete', { exact: false });
  fireEvent.click(deleteButton);
});

it('Renders successfully with mobile', async () => {
