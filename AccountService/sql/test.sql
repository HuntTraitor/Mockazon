...
--- Shopper Data ---
INSERT INTO shopper (data) VALUES (jsonb_build_object('email', 'testuser@gmail.com', 'pwhash', crypt('pass', '87'), 'sub', 'pass2', 'name', 'Test User', 'username', 'testuser', 'role', 'shopper', 'suspended', false, 'shippingInfo', jsonb_build_array(jsonb_build_object('addressLine1', '1234 Elm St', 'city', 'Santa Cruz', 'state', 'CA', 'postalCode', '95060', 'country', 'USA'), jsonb_build_object('addressLine1', '5678 Oak St', 'city', 'Santa Cruz', 'state', 'CA', 'postalCode', '95060', 'country', 'USA')), 'orderHistory', jsonb_build_array(jsonb_build_object('id', 'ORD123', 'createdAt', '2024-05-01T00:00:00Z', 'shippingAddress', jsonb_build_object('name', 'John Doe', 'addressLine1', '123 Main St', 'city', 'Santa Cruz', 'state', 'CA', 'postalCode', '95060', 'country', 'USA'), 'paymentMethod', 'Credit Card', 'subtotal', 49.97, 'totalBeforeTax', 49.97, 'tax', 0, 'total', 49.97), jsonb_build_object('id', 'ORD124', 'createdAt', '2024-05-15T00:00:00Z', 'shippingAddress', jsonb_build_object('name', 'Jane Doe', 'addressLine1', '456 Another St', 'city', 'Santa Cruz', 'state', 'CA', 'postalCode', '95060', 'country', 'USA'), 'paymentMethod', 'PayPal', 'subtotal', 77.96, 'totalBeforeTax', 77.96, 'tax', 0, 'total', 77.96))));
